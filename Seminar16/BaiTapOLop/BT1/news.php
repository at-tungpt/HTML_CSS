	...
	<div class="wrapper">
		...
		<div id="content">
			<div class="content-left fl">
				...
				<ul>
					<li>
						<a href="#" title="">Tin trong nước</a>
					</li>
					<li>
						<a href="#" title="">Tin thế giới</a>
					</li>
					<li>
						<a href="#" title="">Tin thể thao</a>
					</li>
					<li>
						<a href="#" title="">Tin giải trí</a>
					</li>
				</ul>
			</div>
				...
				<div class="main-content">
					<table border="1" cellpadding="5" cellspacing="1" width="100%">
						...
						<tr>
							...
							<td><a href="" title=""><img src="images/active.gif" alt="" /></a></td>
						</tr>
						<tr>
							<td>3</td>
							<td>Giới thiệu diễn viên Châu Tinh Trì</td>
							<td><a href="" title=""><img src="images/deactive.gif" alt="" /></a></td>
						</tr>
						<tr>
							<td>4</td>
